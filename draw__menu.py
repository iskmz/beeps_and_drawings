...
# for this specific case, in order NOT to repeat 23 functions with similar calls (except the call number == selected+1)
# a trick was used by calling the same function and modifying "goto_selection()" function's body below (lines 287-295)
my_menu = {
"1 .  square":fn,
"2 .  circle":fn,
"3 .  triangle":fn,
...
"5 .  spiral in-out":fn,
"6 .  spiral out-in":fn,
"7 .  square-spiral in-out":fn,
"8 .  square-spiral out-in":fn,
"9 .  star":fn,
"10.  star sky":fn,
"11.  hexagon":fn,
"12.  pentagon":fn,
"13.  septagon":fn,
"14.  octagon":fn,
"15.  nested infinity":fn,
"16.  ellipses colorful special":fn,
"17.  spiral of infinity":fn,
"18.  flower":fn,
"19.  cube":fn,
"20.  helix":fn,
"21.  Rainbow Benzene":fn,
"22.  Y Fractal Tree":fn,
"23.  sine wave":fn
}
...
SELECTION_BG_COLOR = BG_COLORS.BR_RED
# 10
